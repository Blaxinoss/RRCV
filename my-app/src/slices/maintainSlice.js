...
const fetchMaintenance = createAsyncThunk('maintenance/fetchMaintenance', async () => {
    const response = await axios.get('https://rrccserver.vercel.app/api/maintenance'); // Fetch maintenance records from the API
...
const addMaintenance = createAsyncThunk('maintenance/addMaintenance', async (maintenanceData, { dispatch }) => {
    const response = await axios.post('https://rrccserver.vercel.app/api/maintenance/add', maintenanceData); // Post new maintenance record to the API
...
const deleteMaintenance = createAsyncThunk('maintenance/deleteMaintenance', async (maintenanceId) => {
    await axios.delete(`https://rrccserver.vercel.app/api/maintenance/${maintenanceId}`); // Delete the maintenance record by ID
...
const updateMaintenance = createAsyncThunk('maintenance/updateMaintenance', async (maintenanceData) => {
    ...
    const response = await axios.put(`https://rrccserver.vercel.app/api/maintenance/update/${maintenanceId}`, updates); // Update the record in the API
