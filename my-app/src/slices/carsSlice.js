...
const addCar = createAsyncThunk('cars/addCar', async (newCar) => {
    const response = await axios.post('https://rrccserver.vercel.app/api/cars/add', newCar);
...
const fetchCars = createAsyncThunk('cars/fetchCars', async () => {
    const response = await axios.get('https://rrccserver.vercel.app/api/cars');
...
const deleteCar = createAsyncThunk('cars/deleteCar', async (carId) => {
    await axios.delete(`https://rrccserver.vercel.app/api/cars/${carId}`);
...
const updateCar = createAsyncThunk('cars/updateCar', async ({ id, ...updatedData }) => {
    const response = await axios.put(`https://rrccserver.vercel.app/api/cars/update/${id}`, updatedData);
